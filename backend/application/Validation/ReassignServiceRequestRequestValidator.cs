...
public sealed class ReassignServiceRequestRequestValidator : AbstractValidator<ReassignServiceRequestRequest>
{
    public ReassignServiceRequestRequestValidator()
    {
