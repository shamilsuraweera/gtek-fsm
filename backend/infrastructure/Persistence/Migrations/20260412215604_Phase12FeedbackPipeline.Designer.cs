...
namespace GTEK.FSM.Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260412215604_Phase12FeedbackPipeline")]
    partial class Phase12FeedbackPipeline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTEK.FSM.Backend.Domain.Aggregates.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("TenantId", "IsActionable", "CreatedAtUtc")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_Feedback_TenantId_IsActionable_CreatedAtUtc");

                    b.HasIndex("TenantId", "Source", "CreatedAtUtc")
                        .IsDescending(false, false, true)
